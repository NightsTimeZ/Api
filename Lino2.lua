...
if CoreGui:FindFirstChild("GolaHub") then 
    CoreGui:FindFirstChild("GolaHub"):Destroy() ;
end

local ProtectGui = protectgui or (syn and syn.protect_gui) or (function() end);

local ScreenGui = Instance.new('ScreenGui');
ScreenGui.Name = "GolaHub" ;
...
local Library = {
    ...
    MainColor = Color3.fromRGB(254,12,100)  ;
...
function Library:AddToolTip(InfoStr, HoverInstance)
    ...
    local Tooltip = Library:Create('Frame', {
        ...
        Size = UDim2.fromOffset(0,0,0,Y + 4),
        ZIndex = 100,
    ...
    HoverInstance.MouseEnter:Connect(function()
        ...
        Tooltip.Position = UDim2.fromOffset(Mouse.X + 20, Mouse.Y + 12)
        ...
        Library:Tween({
            {
                object = Tooltip,
                property = {
                    Size = UDim2.fromOffset(X + 15, Y + 4),
                },              
            },
            {
                object = Label,
    ...
    HoverInstance.MouseLeave:Connect(function()
        ...
        Library:Tween({
            {
                object = Tooltip,
                property = {
                    Size = UDim2.fromOffset(0,0,0,X+4),
                },              
            },
            {
                object = Label,
        ...
        repeat wait() until Tooltip.Size  ==  UDim2.fromOffset(0,0,0,X+4)
        ...
        function KeyPicker:GetState()
            ...
            elseif KeyPicker.Mode == 'Hold' then
                ...
                if Key == 'MB1' or Key == 'MB2' then
                    return Key == 'MB1' and InputService:IsMouseButtonPressed(Enum.UserInputType.Touch)
        ...
        Library:GiveSignal(InputService.InputBegan:Connect(function(Input)
            if (not Picking) then
                if KeyPicker.Mode == 'Toggle' then
                    ...
                    if Key == 'MB1' or Key == 'MB2' then
                        if Key == 'MB1' and Input.UserInputType == Enum.UserInputType.Touch
...
do
    ...
    function Funcs:AddSlider(Idx, Info)
        ...
        local HideBorderRight = Library:Create('Frame', {
            BackgroundColor3 =  Color3.fromRGB(0,110,185);
            BorderSizePixel = 0;
        ...
        function Slider:Display()
            ...
            -- Fill.Size = UDim2.new(0, X + 3, 1, 0);

            Library:Tween({
                {
                    object = Fill,
                    property = {
                        Size = UDim2.new(0, X + 3, 1, 0);
                    },              
                },
            },0.2,Enum.EasingStyle.Quad)
    ...
    function Funcs:AddDropdown(Idx, Info)
        ...
        local ListOuter = Library:Create('Frame', {
            BorderColor3 = Color3.new(0, 0, 0);
            Position = UDim2.new(0, 4, 0, 20 + RelativeOffset + 1 + 25);
        ...
        local SearchOuter = Library:Create("Frame",{
          Position = UDim2.new(0., 5, 0, 20 + RelativeOffset + 1 - 23 );
          Parent = Container.Parent ; 
        ...
        local Scrolling = Library:Create('ScrollingFrame', {
            ...
            ScrollBarImageColor3 =  Color3.fromRGB(254,12,100)  ,
        });
        ...
        Scrolling.UIListLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
          Scrolling.CanvasSize =  UDim2.new(0, 0, 0,  Scrolling.UIListLayout.AbsoluteContentSize.Y )
      end);
        ...
        function Dropdown:SetValues()
            ...
            for Idx, Value in next, Values do
                ...
                ButtonLabel.TextColor3 = Color3.fromRGB(25,25,25);
                ...
                function Table:UpdateButton()
                    ...
                    if Selected then 
                        ...
                        ButtonLabel.TextColor3 = Color3.fromRGB(155,155,155);
                    end ; 

                    -- if not Info.Multi then 
                    --     if ButtonLabel.Text == Selected then 
                    --         ButtonLabel.TextColor3 = Color3.fromRGB(25,25,25);
                    --     else
        ...
        TextBox:GetPropertyChangedSignal("Text"):Connect(function()
            for _, Element in next, Scrolling:GetChildren() do
              if not Element:IsA('UIListLayout') and Element:IsA("Frame") then
                  if string.lower(Element.TextLabel.Text):match(TextBox.Text:lower()) then 
        ...
        Dropdown.SetSee = function(see)
            Container.Visible = see ;
        end;
...
function Library:CreateWindow(...)
    ...
    if typeof(Config.Size) ~= 'UDim2' then Config.Size = UDim2.fromOffset(550, 600/2.2) end
    ...
    WindowLabel.TextStrokeTransparency = 1
    ...
    function Window:AddTab(Name)
        ...
        TabButtonLabel.TextStrokeTransparency = 1
        ...
        for _, Side in next, { LeftSide, RightSide } do
            Side:WaitForChild('UIListLayout'):GetPropertyChangedSignal('AbsoluteContentSize'):Connect(function()
                Side.CanvasSize = UDim2.fromOffset(0, Side.UIListLayout.AbsoluteContentSize.Y + 30);
            end);
        end;
